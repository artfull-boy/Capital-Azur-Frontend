...
export const config = {
	id: "vactory_default:72",
}

export const ParallaxCTAVideoLeft = ({ title, content, thumbnail, videoId, cta }) => {
	...
	return (
		<Container className="my-24">
			<div ref={containerRef} className="relative flex flex-col gap-x-16 md:flex-row">
...
const ParallaxCTAVideoLeftContainer = ({ data }) => {
	const widgetData = {
	...
	return <ParallaxCTAVideoLeft {...widgetData} />
}

export default ParallaxCTAVideoLeftContainer
