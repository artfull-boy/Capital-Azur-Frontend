...
export const ParallaxInternalCTAFullImageLeft = ({ title, content, image, cta }) => {
	...
	return (
		<div className="relative md:h-[80vh]">
			<Container className="my-24">
				<div className="mb-16 ml-auto h-full md:mb-0 md:flex md:w-1/2 md:items-center md:pl-16">
					<motion.div
						initial="initial"
						whileInView="animate"
						viewport={{ once: true }}
			...
			<div
				...
				className="relative left-0 top-0 h-96 overflow-hidden md:absolute md:h-[80vh] md:w-1/2"
			>
				<motion.img
...
const ParallaxInternalCtaFullImageLeftContainer = ({ data }) => {
	const widgetData = {
	...
	return <ParallaxInternalCTAFullImageLeft {...widgetData} />
}

export default ParallaxInternalCtaFullImageLeftContainer
