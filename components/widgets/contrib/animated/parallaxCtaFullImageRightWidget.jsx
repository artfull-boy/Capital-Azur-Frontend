...
const ParallaxCtaFullImageRight = ({ title, content, image, cta }) => {
	...
	return (
		<div className="relative md:h-[70vh]">
			<div ref={containerRef}>
				<Container className="my-24">
					<motion.div
						...
						className="mb-16 mr-auto md:mb-0 md:w-6/12 md:pr-16"
					>
						<motion.h2
			...
			<div className="relative right-0 top-0 z-20 h-96 overflow-hidden md:absolute md:h-[60vh] md:w-6/12">
				<motion.img
...
const ParallaxCtaFullImageRightContainer = ({ data }) => {
	const widgetData = {
	...
	return <ParallaxCtaFullImageRight {...widgetData} />
}

export default ParallaxCtaFullImageRightContainer
