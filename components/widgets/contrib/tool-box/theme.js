export const toolbox = {
	default: {
		...
		item: {
			...
			itemIcon: "",
			itemTitle:
				"flex items-center justify-center text-primary-1000 text-sm w-48 font-bold  group-hover:text-white flex items-center group-hover:bg-primary-500",
		},
	},
	animatedBox: {
		...
		item: {
			...
			itemIcon:
				"flex items-center justify-center text-white bg-gray-500 rounded-l-md rtl:rounded-r-md p-2 group-hover:bg-warning-500 ",
			itemTitle: "w-48  text-white bg-white flex items-center group-hover:bg-warning-500",
		},
	},
}
