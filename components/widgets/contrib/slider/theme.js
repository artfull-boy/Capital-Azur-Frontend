export const slider = {
	default: {
		...
		arrows: {
			wrapper:
				"absolute top-1/2 -translate-y-1/2 items-center justify-center cursor-pointer py-2 px-2 border border-solid border-primary-500 text-primary-500 hover:bg-primary-500 hover:text-white rounded-full  transition transition-all ease-in-out delay-200 rtl:rotate-180",
		...
		dots: {
			...
			dotActive:
				"active bg-warning-500 p-2  sm:transition sm:ring-2 sm:ring-gray-50 sm:ease-in-out sm:delay-100 ",
		},
	},
	v1: {
		wrapper: "h-96 w-full",
		slide: {
			wrapper: "h-full w-full flex relative bg-error-300 text-black",
			content:
				"absolute top-0 left-0 w-full h-full flex items-center justify-center flex-col",
			bgVideo: "w-full h-full absolute top-0 left-0 overflow-hidden",
			image: "absolute top-0 left-0 w-full h-full object-cover",
