...
import { Accordion, Container, Heading, Icon, Image, Tabs, Text } from "@/ui"
import { useAmp } from "next/amp"

const PageNodAmp = ({ node }) => {
	const isAmp = useAmp()
	return (
		<React.Fragment>
...
export const config = {
	...
	params: {
		fields: {
			"node--vactory_page":
				"field_vactory_paragraphs,node_bg_image,node_class,node_body_class,node_banner_title,node_banner_image,node_banner_mobile_image",
