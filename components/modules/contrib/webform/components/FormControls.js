...
import { FormControlContext } from "@vactorynext/core/webform"
...
export const FormControl = (props) => {
	...
	const _className = classNames("ui-form-control mb-4", props.className, {
...
export const RequiredIndicator = (props) => {
	...
	return (
		<span role="presentation" aria-hidden {...props} className={_className}>
			{props.children || "*"}
		</span>
	)
}
